                ...
                <table v-else border="1" class="grid-header-table">
                    <tr v-for="tr in header.structure" :key="tr.index">
                        ...
                        <td v-for="(td, index) in tr.children" :key="index" :colspan="td.colspan"
                            ...
                            <div class="td-holder">
                                <Tooltip class="add-td-next" content="Энэ баганы дараа багана нэмэх" placement="top">
                                ...
                                <div class="td-control">
                                    <div>
                                        <span>w</span>
                                        <input type="text" v-model="td.width" placeholder="width">
                                    </div>
                                    <div>
                                        <span>h</span>
                                        <input type="text" v-model="td.height" placeholder="height">
                                    </div>
                                    <div>
                                        <span>col</span>
                                        <input type="text" v-model="td.colspan" placeholder="col">
                                    </div>
                                    <div>
                                        <span>row</span>
                                        <input type="text" v-model="td.rowspan" placeholder="row">
                                    </div>
                                    <div>
                                        <span>deg</span>
