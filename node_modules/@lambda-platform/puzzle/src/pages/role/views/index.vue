  ...
  <section class="page">
    ...
    <section class="paper-page-body">
      <div class="role-control">
        ...
        <div class="role-list">
          <Button icon="md-add" type="success" long @click="addRole">Нэмэх</Button>
          <ul>
        ...
        <div class="role-config">
          <div id="menu-tree" v-if="selectedRole != null">
            <Select v-model="menuIndex" clearable placeholder="Цэс сонгох" style="width: 300px"
            ...
            <Select v-if="Object.keys(permissions).length >=1"
                    ...
                    placeholder="Анхдагч цэс"
                    style="width: 200px">
              <Option v-for="item in Object.keys(permissions)" :value="getMenuUrl(permissions[item].menu_id)"
            ...
            <Button icon="android-done" type="success" @click="saveRole">Хадгалах</Button>
          ...
          <Modal v-model="showRoleForm" title="Үүрэг">
            <Form ref="roleForm" :model="roleForm" :rules="ruleRole">
              <FormItem prop="name">
                <Input type="text" v-model="roleForm.name" placeholder="Нэр"/>

              </FormItem>
              <FormItem prop="display_name">
                <Input type="text" v-model="roleForm.display_name" placeholder="Харагдах нэр"/>
              </FormItem>
              <FormItem prop="description">
                <Input type="textarea" v-model="roleForm.description" placeholder="Тайлбар"/>
              </FormItem>
              <FormItem>
                <Button type="primary" :loading="loadingForm" @click="saveRoleForm">Хадгалах</Button>
                <Button type="info" style="margin-left: 8px" @click="closeRole">Болих</Button>
              </FormItem>
            </Form>
...
export default {
  ...
  methods: {
            ...
            if (sub_menu_index >= 0) {
              ...
              menu.children.forEach(sub_menu => {
                ...
                if (sub_child_menu_index >= 0) {
                  url = "#/p/" + menu.id + "/" + sub_menu.id + "/" + menu_id;
                }
              });
            }
          });
    ...
    getData() {
      this.loading = true;
      axios.get('/lambda/puzzle/roles-menus').then(res => {
        if (res.data.status) {
    ...
    saveRole() {
      ...
      if (this.roles[this.selectedRole].permissions) {
        if (this.roles[this.selectedRole].permissions.default_menu) {
          axios.post('/lambda/puzzle/save-role', {
