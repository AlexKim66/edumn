<template>
    <section class="form-builder">
        ...
        <div class="fb-sidebar">
            ...
            <div class="fb-submit">
                <Button type="success" long @click="saveForm">{{`${$static_words ? $static_words.save : 'Хадгалах'}`}}</Button>
            </div>
        </div>
                                ...
                                <Col span="10">
                                    <div class="formula-form-wrapper">
                                        <Form ref="formula" label-position="top" :model="formulaForm"
                                            ...
                                            <FormItem>
                                                <Button type="primary" @click="addFormula">{{`${$static_words ? $static_words.add : 'Нэмэх'}`}}</Button>
                                            </FormItem>
                                        </Form>
                                    </div>
                                </Col>
