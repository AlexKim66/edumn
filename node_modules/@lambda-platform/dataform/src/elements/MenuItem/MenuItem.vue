...
<!--        </div>-->
        <button type="button" class="ivu-btn ivu-btn-default ivu-btn-circle ivu-btn-icon-only" @click="showIconModal">
          <i :class="`${data.icon} menu-icon-preview`" v-if="data.icon" ></i> <span v-else></span>
        </button>

      </div>

      <select placeholder="Цэсний төрөл" class="menu_types ivu-input ivu-input-small" v-model="data.link_to">
        <option value="crud">Маяг, хүснэгтийн нэгтгэл</option>
        <option value="link">Холбоос 'a'</option>
        <option value="router-link">Холбоос 'spa'</option>
        <option value="iframe">iframe хуудас</option>
        <option value="noAction">Үйлдэлгүй</option>
        <option value="divider">Хуваалт</option>
      </select>
      <div class="ivu-input-wrapper ivu-input-wrapper-small ivu-input-type menu-cruds" v-if="data.link_to == 'crud'">
        <div class="ivu-input-inner-container" style="">
          <input list="cruds" name="cruds" type="text" autocomplete="off" v-model="url" @change="setCrud"
                 placeholder="Нэр" class="ivu-input ivu-input-small">
          <div class="" v-show="url != null" @click="url = null"><i
              class="ivu-icon ivu-icon-ios-close-circle ivu-select-arrow data-clear-icon"></i></div>
        </div>
      </div>
      ...
      <div class="menu-title"
        ...
        <div class="ivu-input-wrapper ivu-input-wrapper-small ivu-input-type">
          <div class="ivu-input-inner-container" style=""><i
              class="ivu-icon ivu-icon-ios-loading ivu-load-loop ivu-input-icon ivu-input-icon-validate"></i> <input
              autocomplete="off" spellcheck="false" type="text" placeholder="Холбох зам" v-model="data.url"
      ...
      <div class="ivu-input-wrapper ivu-input-wrapper-small ivu-input-type menu-cruds" v-if="data.link_to != 'crud'">
          ...
          <div class="ivu-input-inner-container" style=""><i
              class="ivu-icon ivu-icon-ios-loading ivu-load-loop ivu-input-icon ivu-input-icon-validate"></i> <input
              v-model="data.title"
              autocomplete="off" spellcheck="false" type="text" placeholder="Нэр" class="ivu-input ivu-input-small">
          </div>

      </div>

      <select size="small" filterable placeholder="target" v-if="data.link_to == 'link'"
      ...
      <div class="buttons">
        <button type="button" class="ivu-btn ivu-btn-default ivu-btn-circle ivu-btn-icon-only" @click="addItem"><i
            class="ivu-icon ivu-icon-md-add"></i></button>
        <button type="button" class="ivu-btn ivu-btn-default ivu-btn-circle ivu-btn-icon-only" @click="deleteChild"><i
            class="ivu-icon ivu-icon-md-remove"></i></button>
      </div>
    </div>
