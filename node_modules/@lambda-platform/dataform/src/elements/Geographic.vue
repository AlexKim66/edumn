    ...
    <FormItem :label=label :prop=rule>
        <div class="geographic">
            ...
            <div id="side_bar" :class="openSide ? 'open' : ''">
                ...
                <span v-if="geometryType != 'point'"> Солбицол оо оруулаад "Enter" дарна уу</span>
                ...
                <Button type="success" @click="saveGraphic">{{ `${$static_words ? $static_words.save : 'Хадгалах'}` }}</Button>
                <Button type="warning" @click="cancelGraphic">{{`${$static_words ? $static_words.cancel : 'Болих'}`}}</Button>
...
// this.clearSearchLayer();
            if (this.checkByArea && data) {
                if (this.searchLayer) {
                    ...
                    this.model.form[this.model.component] = null;
                    this.$Message.error('Талбай сонгогдоогүй байнай !!!');
                }
            } else
                this.model.form[this.model.component] = data;
                ...
                if (this.latlngMode == "DMS") {
                    if (
                        ...
                        if (this.IsValidCoordinates([this.new_point.lng, this.new_point.lat])) {
                            ...
                            this.$Notice.error({
                                title: 'Алдаа',
                                desc: "Солбицол оо зөв оруулна уу"
                            });
        ...
        initMap() {
            ...
            this.map.on(L.Draw.Event.CREATED, (e) => {
                ...
                if (this.meta && this.meta.disabled) {
                    alert('Мэдээлэл өөрчлөх эрх байхгүй байна');
                } else {
                    this.createFeature(layer);
                    this.cancelGraphic();
                }
