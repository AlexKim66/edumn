    ...
    <div className="contact-area pb-100">
      <div className="container">
        <div className="section-title">
          ...
          <h2>
            Имэйл илгээх<span className="overlay"></span>
          </h2>
          <p>
            Таны имэйл хаяг нийтлэгдэхгүй. Шаардлагатай талбаруудыг бөглөөд
            илгээх товчыг дарна уу !
          </p>
        </div>
                  ...
                  <div className="col-lg-12 col-md-6">
                    <div className="form-group">
                      ...
                      <div
                        ...
                        style={{ display: "block" }}
                      >
                        {errors.number && "Утасны дугаараа оруулна уу."}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-12 col-md-6">
                    <div className="form-group">
                      ...
                      <div
                        ...
                        style={{ display: "block" }}
                      >
                        {errors.subject && "Гарчигаа оруулна уу."}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-12 col-md-12">
                    <div className="form-group">
                      ...
                      <div
                        ...
                        style={{ display: "block" }}
                      >
                        {errors.text && "Санал хүсэлтээ оруулна уу."}
                      </div>
                    </div>
                  </div>
